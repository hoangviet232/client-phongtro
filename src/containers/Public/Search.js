...
const Search = () => {
    ...
    const { provinces, areas, prices, categories, posts } = useSelector(state => state.app)
    ...
    return (
        <>
            <div className='p-[10px] w-3/5 my-3 bg-[#febb02] rounded-lg flex-col xl:flex-row flex items-center justify-around gap-2' >
                ...
                <button
                    ...
                    className="outline-none py-2 px-4 flex-1 bg-secondary1 text-[13.3px] flex items-center justify-center gap-2 text-white font-medium ease-in duration-300 ..."
